...
[data-testid="stAppViewContainer"]{
    background: #ffffff url(https://images.pexels.com/photos/1000445/pexels-photo-1000445.jpeg) center center/cover no-repeat;
    }
</style>
'''
...
menu = ["Legit Community", "View Posts", "Add Post", "Search", "Manage"]
choice = st.sidebar.selectbox("Menu", menu)

# Display the selected option
if choice == "Legit Community":
    st.title("Welcome to Legit Community")
